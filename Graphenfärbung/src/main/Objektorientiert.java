...
public class Objektorientiert {
    ...
    public static boolean FärbungsUtil(Graph graph, int Farben[], int Knoten){
        ...
        if (Knoten == main.landingWindow.KnotenAnzahl){
            return true;
        } else {
            ...
            for (int Farbvorschlag = 1; Farbvorschlag <= Knoten + 1; Farbvorschlag++){
                ...
                if (Sicher(graph, Farben, Knoten, Farbvorschlag)){
                    ...
                    if (FärbungsUtil(graph, Farben, Knoten + 1)){
    ...
    public static boolean Sicher(Graph graph, int Farben[], int Knoten1, int Farbvorschlag){
        ...
        for (int Knoten2 = 0; Knoten2 < main.landingWindow.KnotenAnzahl; Knoten2++){
